...
if (merged['_merge'] == 'left_only').any():
    print("\033[31mOld rows in the common_samples.tsv have been modified or deleted\033[0m")
    exit(1)

# Everything is OK
print("\033[92mNo old rows have been modified or deleted in common_samples.tsv\033[0m")
