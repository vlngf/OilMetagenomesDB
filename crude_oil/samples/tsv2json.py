    ...
    rows = [
        {
            ...
            "sequence_name": None if row["sequence_name"] == "NA" else (str(row["sequence_name"]) if row["sequence_name"] != "" else None) if "sequence_name" in row and row["sequence_name"] is not None else ValueError("Empty sequence_name"),
